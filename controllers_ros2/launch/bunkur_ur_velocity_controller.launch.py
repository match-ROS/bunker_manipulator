...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument("base_link", default_value="bunkur/base_link"),
        DeclareLaunchArgument("tip_link", default_value="bunkur/ur/tool0"),
        DeclareLaunchArgument("robot_description_topic", default_value="/bunkur/robot_description"),
        DeclareLaunchArgument("twist_topic", default_value="~/twist_cmd"),
        DeclareLaunchArgument(
            "command_topic",
            default_value="/bunkur/forward_velocity_controller_ur/commands",
        ),
        DeclareLaunchArgument("joint_states_topic", default_value="/bunkur/joint_states"),
        DeclareLaunchArgument(
            "singular_values_topic",
            default_value="/bunkur/jparse_velocity_controller_ur/singular_values",
        ),
        DeclareLaunchArgument(
            "debug_twist_topic",
            default_value="/bunkur/jparse_velocity_controller_ur/debug_twist",
        ),
